    ...
    <div className="relative bg-white">
      <section className="border-b border-gray-200 relative overflow-hidden bg-white">
        ...
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-8 px-4 pb-40 pt-32 text-center sm:pb-48 sm:pt-36 relative">
          ...
          <h1 className="text-2xl font-light leading-tight text-gray-900 sm:text-3xl md:text-5xl tracking-tight">
            Increase your brand's <span className="font-medium text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-purple-800">attribution</span> inside AI answers.
          </h1>
          <p className="max-w-2xl text-base text-gray-600 sm:text-lg leading-relaxed font-light">
            Run a <span className="font-medium text-purple-600">radar</span> across leading LLMs, measure <span className="font-medium text-gray-900">citations</span>, and uncover where you can replace competitor links with
      ...
      <section className="border-b border-gray-200 bg-purple-50/30 py-16 sm:py-20 relative overflow-hidden">
        <div className="mx-auto max-w-full px-4">
          ...
          <div className="relative">
            ...
            <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-purple-50/90 via-purple-50/30 to-transparent z-10 pointer-events-none" />
            <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-purple-50/90 via-purple-50/30 to-transparent z-10 pointer-events-none" />
      ...
      <section className="border-b border-gray-200 bg-white py-20">
        <div className="mx-auto max-w-6xl px-4">
          <div className="max-w-xl space-y-4">
            <h2 className="text-3xl font-light text-gray-900 sm:text-4xl leading-tight tracking-tight">Position your brand inside <span className="font-medium text-purple-600">AI answers</span>.</h2>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {features.map((feature) => (
              ...
              >
                ...
                <div className="relative">
                  <p className="text-xs font-semibold uppercase tracking-widest text-purple-600">{feature.accent}</p>
                  <h3 className="mt-3 text-2xl font-light text-gray-900">{feature.title}</h3>
                  <p className="mt-4 text-sm leading-relaxed text-gray-700 font-light">{feature.description}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="border-b border-gray-200 bg-purple-50/30 py-10">
        <div className="mx-auto flex max-w-6xl flex-col gap-12 px-4 md:flex-row md:items-center">
          ...
          <div className="md:w-1/2">
            <p className="text-xs font-semibold uppercase tracking-[0.4em] text-purple-600">Live workspace</p>
            <h2 className="mt-4 text-3xl font-light text-gray-900 sm:text-4xl leading-tight tracking-tight">
              From <span className="text-purple-600 font-medium">prompt-level insights</span> to executive-ready proof.
            </h2>
            <ul className="mt-8 space-y-4 text-sm text-gray-700 font-light">
      ...
      <section className="border-b border-gray-200 bg-purple-50/30 py-20">
        <div className="mx-auto max-w-6xl px-4">
          <div className="grid gap-10 md:grid-cols-3 md:items-start">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.4em] text-purple-600">How it works</p>
              <h2 className="mt-4 text-3xl font-light text-gray-900 leading-tight tracking-tight">Put AI attribution on <span className="text-purple-600 font-medium">autopilot</span>.</h2>
              <p className="mt-4 max-w-sm text-sm text-gray-600 leading-relaxed font-light">
                Collaborate with cross-functional teams, keep leadership aligned, and shift share faster with a tight
                workflow from <span className="font-medium text-gray-900">insight to proof</span>.
              </p>
            </div>
              ...
              <ol className="space-y-6">
                {process.map((step) => (
                  ...
                  >
                    ...
                    <p className="mt-4 text-sm leading-relaxed text-gray-700 font-light">{step.body}</p>
                  </li>
                ))}
              </ol>
            </div>
        ...
        <div className="mx-auto max-w-6xl px-4">
          <div className="grid gap-10 lg:grid-cols-2">
            <div className="rounded-3xl border border-gray-200 bg-purple-50/30 p-8 transition hover:border-purple-300 hover:shadow-md">
              <p className="text-xs font-semibold uppercase tracking-[0.4em] text-purple-600">Customers</p>
              <blockquote className="mt-6 space-y-6">
                <p className="text-2xl font-light leading-relaxed text-gray-900 italic">
                  "CORE helped us move from vague 'LLM visibility' conversations to <span className="font-medium text-purple-600">quantifiable revenue</span> conversations in
                  under a month. We now show up where buying journeys actually start."
                </p>
                <footer className="text-sm text-gray-600 font-light">
                  <span className="font-medium text-gray-900">Harper Singh</span> · VP Growth, Flux Analytics
                </footer>
              </blockquote>
            </div>
            <div className="rounded-3xl border border-gray-200 bg-purple-50/30 p-8 transition hover:border-purple-300 hover:shadow-md">
              <p className="text-xs font-semibold uppercase tracking-[0.4em] text-purple-600">FAQ</p>
              <div className="mt-6 space-y-6">
                {faqs.map((faq) => (
                  <div key={faq.question}>
                    <p className="text-sm font-medium text-gray-900">{faq.question}</p>
                    <p className="mt-2 text-sm leading-relaxed text-gray-600 font-light">{faq.answer}</p>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="border-b border-gray-200 bg-purple-50/30 py-20">
        <div className="mx-auto max-w-6xl px-4">
          <div className="mb-12 text-center">
            <p className="text-xs font-semibold uppercase tracking-[0.4em] text-purple-600">Team</p>
            <h2 className="mt-4 text-3xl font-light text-gray-900 leading-tight tracking-tight">Operators who have lived the attribution gap.</h2>
          </div>
          <div className="grid gap-6 md:grid-cols-3">
            {teamMembers.map((member) => (
              ...
              >
                ...
                <p className="mt-3 text-sm leading-relaxed text-gray-600 font-light">{member.bio}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-4xl rounded-[36px] border border-purple-200 bg-gradient-to-br from-purple-100 via-white to-purple-50/30 px-6 py-16 text-center shadow-md sm:px-12">
          <p className="text-xs font-semibold uppercase tracking-[0.4em] text-purple-700">Ready to reclaim your answers?</p>
          <h2 className="mt-6 text-3xl font-light text-gray-900 sm:text-4xl leading-tight tracking-tight">
            Launch a live <span className="text-purple-600 font-medium">CORE radar</span> in under five minutes.
          </h2>
          <p className="mt-4 text-sm text-gray-600 leading-relaxed font-light">
            Bring a list of <span className="font-medium text-gray-900">prompts or keywords</span>. We will surface coverage, opportunities, and proof instantly.
          </p>
